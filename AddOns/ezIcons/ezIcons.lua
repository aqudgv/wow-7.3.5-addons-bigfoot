...
local menu, doubleClick, doubleClickX, playerFaction;
...
function ezIcons:OnEnable()
	...
	-- self:RegisterEvent("UPDATE_MOUSEOVER_UNIT");			-- 去掉shift 标记
end
...
function ezIcons:buildMenu()
	...
	menu:SetScript("OnUpdate", function(this)
	...
	menu:SetScript("OnClick", function(this)
			if ( not this.h ) then
	...
	menu:SetScript("OnEvent", function(this)
